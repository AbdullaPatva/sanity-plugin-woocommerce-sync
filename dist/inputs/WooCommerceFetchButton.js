...
export function WooCommerceFetchButton(props) {
    ...
    const wooIdValue = useFormValue(['wooId']) || 0;
    const documentID = useFormValue(['_id']) || null;
    ...
    return (_jsx(Card, { padding: 3, tone: "primary", radius: 2, shadow: 1, children: _jsxs(Stack, { space: 3, children: [_jsx(Flex, { gap: 2, children: _jsx(Button, { text: schemaType.title, tone: "positive", disabled: !wooIdValue || loading || isLoadingSettings, onClick: handleFetchFromWooCommerce, loading: loading }) }), _jsx(Text, { size: 1, muted: true, children: isLoadingSettings
                        ...
                        : !woocommerceSettings?.storeUrl
                            ...
                            : !wooIdValue
                                ...
                                : loading
                                    ...
                                    : `Ready to fetch product data for ID: ${wooIdValue}` }), wooIdValue && !loading && !isLoadingSettings && (_jsxs(Text, { size: 1, muted: true, children: ["\u2705 Product ID entered: ", wooIdValue] }))] }) }));
}
